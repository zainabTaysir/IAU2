...
public class Ad2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("If you're interested in gaining experience in business research, \ndata collection, analysis, and report writing,\n you can apply for virtual volunteering projects.\n You'll work alongside faculty members on topics such as marketing, \nfinance, and management, gaining valuable skills\n and knowledge in the field. Apply now if you're interested!");
        jScrollPane1.setViewportView(jTextArea1);

        getContentPane().add(jScrollPane1);
        jScrollPane1.setBounds(10, 80, 380, 120);

        jLabel2.setFont(new java.awt.Font("Times New Roman", 3, 18)); // NOI18N
        jLabel2.setText("Social Media");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(150, 40, 140, 21);
